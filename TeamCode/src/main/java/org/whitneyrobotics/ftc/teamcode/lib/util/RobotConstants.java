...
public class RobotConstants {
    ...
    public static ControlConstants ROTATE_CONSTANTS = new ControlConstants(1.5, 0.0075, 0.12);

    //Outtake
    public static double OUTTAKE_MAX_VELOCITY = 2120;
    ...
    public static ControlConstants FLYWHEEL_CONSTANTS = new ControlConstants(8.6,0.00091,0.82, flywheelKF);
